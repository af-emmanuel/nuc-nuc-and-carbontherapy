...
//all graph classes associated to all 6 bragg peak dose
        ...
        BF [i]  = new TGraph(no_points,CSVobject. X_axis,CSVobject.SF);
        ...
        BG[i]  = new TGraph(no_points,CSVobject. X_axis,CSVobject.SF);
        ...
        QF[i]  = new TGraph(no_points,CSVobject. X_axis,CSVobject.SF);
        ...
        QG [i] = new TGraph(no_points,CSVobject. X_axis,CSVobject.SF);
        ...
        EM[i]  = new TGraph(no_points,CSVobject. X_axis,CSVobject.SF);
