...
//all graph classes associated to all 6 bragg peak dose
        ...
        BF [i]  = new TGraph(200,CSVobject. X_axis,CSVobject.SF);
        ...
        BG[i]  = new TGraph(200,CSVobject. X_axis,CSVobject.SF);
        ...
        QF[i]  = new TGraph(200,CSVobject. X_axis,CSVobject.SF);
        ...
        QG [i] = new TGraph(200,CSVobject. X_axis,CSVobject.SF);
        ...
        EM[i]  = new TGraph(200,CSVobject. X_axis,CSVobject.SF);
        ...
        c->cd(1);
        c_b [i]= (TPad*)(c->GetPrimitive(TString::Format("c_%d",1)));
        //c_b[i]->SetLogy();
...
//////////////////////////////////////////////////////////////////legends   
        ...
        leg[i]->SetHeader(TString::Format(/*fig[i]+*/" at %dGy",BraggPeakDose[i]),"C");
