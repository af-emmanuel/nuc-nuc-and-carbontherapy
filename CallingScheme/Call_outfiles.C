...
{ 
 ...
 TFile *f=new TFile("CallEnergy.root"); //gets root file5.263600e-04
 ...
 for(int i=0; i<no_files;i++)
        ...
        fout[i].open("/home/atukpor/Documents/survival/my_examples/ParticleField"  + to_string(i) + ".mixedField");
