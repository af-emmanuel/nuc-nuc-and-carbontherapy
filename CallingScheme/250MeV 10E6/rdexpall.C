...
{	
        ...
        TString particleType [11]{"null","H","He", "Li(*10)", "Be(*10)", "B(*10)", "C","N(*20)", "O(*10)", "F(*50)","Ne(*50)"};
        int lincol[10]{600,416,860,840,880,900,800,616,400,1};

        //int lincol[10]{600,416,920,1,880,900,860,800,840,400};
        ...
        for (int n=0; n<5;n++)
        {
                for(int p=0;p<10;p++)
                {
                        ...
                        CSVobject. readCSV(nuc[n]+"paticles.csv"); 
                //========================fill array==============================================
                        if(p==2||p==3||p==7) 
                        {
                               for (int i=0;i<405;i++)
                                {
                                        y[i]= 10* CSVobject.Y_element[i][p];
                      ...
                      else if(p==6) 
                        {
                               for (int i=0;i<405;i++)
                                {
                                        y[i]= 20* CSVobject.Y_element[i][p];
                        ...
                        else if(p==9||p==8) 
                        {
                               for (int i=0;i<405;i++)
                                {
                                        y[i]= 50* CSVobject.Y_element[i][p];
                ...
                if (c_b[4]||c_b[0]||c_b[1])
                   {
                      ...
                      mg[n]->GetYaxis()->SetTitle("number of ion types"); 
