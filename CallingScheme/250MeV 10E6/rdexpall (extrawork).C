...
{	
        ...
        int lincol[10]{600,860,416,632,880,900,800,616,400,1};
                ...
                for(int j=0; j<3;j++)
                  {
                    ...
                    c_b [j]= (TPad*)(c->GetPrimitive(TString::Format("c_%d",j+1)));  
                  
                  }
                  
                  
                  
                 TCanvas * c_b[1] = new TCanvas("c1","c1",700,1000/3);
                ...
                if (c_b[4]||c_b[5])
                   {
                      ...
                      mg[4]->GetYaxis()->SetTitle("number of ion types"); 
                      mg[4] -> GetYaxis() -> CenterTitle();
                    }*/
