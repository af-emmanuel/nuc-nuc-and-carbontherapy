...
{ 
 ...
 TFile *f=new TFile("CallEnergyBF.root"); //gets root file5.263600e-04 
 ...
 ofstream dose;
 dose.open("/home/atukpor/Documents/survival/my_examples_LEM/dose_BF.csv");
 ...
 for(int i=0; i<no_files;i++)
        ...
        fout[i].open("/home/atukpor/Documents/survival/my_examples_LEM/ParticleFieldBF"  + to_string(i) + ".mixedField");
