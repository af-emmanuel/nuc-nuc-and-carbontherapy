...
{ 
 ...
 ofstream dose;
 dose.open("/home/atukpor/Documents/survival/my_examples_MKM/dose_EM.csv");
 ...
 for(int i=0; i<no_files;i++)
        ...
        fout[i].open("/home/atukpor/Documents/survival/my_examples_MKM/ParticleFieldEM"  + to_string(i) + ".mixedField");
