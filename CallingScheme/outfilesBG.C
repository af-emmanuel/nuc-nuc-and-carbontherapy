...
{ 
 ...
 double high_energy[15]{0,10.00E+03,2.500e+03,1.428e+03,1.111e+03,9.090e+02,8.333e+02,
  ...
  ofstream dose;
 dose.open("/home/atukpor/Documents/survival/my_examples_MKM/dose_BG.csv");
 ...
 for(int i=0; i<no_files;i++)
        ...
        fout[i].open("/home/atukpor/Documents/survival/my_examples_MKM/ParticleFieldBG"  + to_string(i) + ".mixedField");
