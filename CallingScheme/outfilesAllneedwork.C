...
public:
        ...
        void datafiles(string file)
        { 


         rootfile =file;
         string nn_model = rootfile.erase(rootfile.find(',')).erase(0,10);
         ...
         TFile *f=new TFile(rootfile); //gets root file
         ...
         //energy limits/bounds from srim data
         ...
         ofstream dose;
         dose.open("/home/atukpor/Documents/survival/my_examples/dose_"+nn_model+".csv");
         ...
         for(int i=0; i<no_files;i++)
                ...
                fout[i].open("/home/atukpor/Documents/survival/my_examples/ParticleField"+nn_model + to_string(i) + ".mixedField");
...
outfiles out;
out. datafiles("CallEnergyEM.root");
