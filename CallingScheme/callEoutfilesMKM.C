...
{ 
 ...
 dose[j].open("/home/atukpor/Documents/survival/my_examples_MKM/dose_" + nuc1[j]+".csv");
        ...
        fout[i].open("/home/atukpor/Documents/survival/my_examples_MKM/ParticleField" + nuc1[j] + to_string(i) + ".mixedField");
