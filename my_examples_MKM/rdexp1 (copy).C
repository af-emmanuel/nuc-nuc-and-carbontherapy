...
{	
        ...
        CSVobject. readCSV("ParticleFieldBF_HSG_MKM_LQparameters_MKM.csv","dose_BF.csv",1);        
        TGraph *BF  = new TGraph(405,CSVobject. X_axis,CSVobject.SF);
        BF->SetTitle("BF");
        BF->SetMarkerStyle(29);
        BF->SetMarkerColor(3);

       CSVobject. readCSV("ParticleFieldBG_HSG_MKM_LQparameters_MKM.csv","dose_BG.csv",1);
        TGraph *BG  = new TGraph(405,CSVobject. X_axis,CSVobject.SF);
        BG->SetTitle("BG");
        BG->SetMarkerStyle(39);
        BG->SetMarkerColor(2);

        CSVobject. readCSV("ParticleFieldQF_HSG_MKM_LQparameters_MKM.csv","dose_QF.csv",1);  
        TGraph *QF  = new TGraph(405,CSVobject. X_axis,CSVobject.SF);
        QF->SetTitle("QF");
        QF->SetMarkerStyle(20);
        QF->SetMarkerColor(7);

        CSVobject. readCSV("ParticleFieldQG_HSG_MKM_LQparameters_MKM.csv","dose_QG.csv",1); 
        TGraph *QG  = new TGraph(405,CSVobject. X_axis,CSVobject.SF);
        QG->SetTitle("QG");
        QG->SetMarkerStyle(49);
        QG->SetMarkerColor(4);

        CSVobject. readCSV("ParticleFieldEM_HSG_MKM_LQparameters_MKM.csv","dose_EM.csv",1);  
